...
function Hero() {
  return (
    <section className="w-full h-screen flex items-center justify-center overflow-hidden bg-[#121212] gap-[10vw] pt-12" id='home'>
      ...
      <aside className="h-[37rem] w-[30rem] flex items-center justify-center">
        <div className="w-full h-full overflow-hidden flex items-start justify-center"><Image className="z-10 mt-4" src="/Images/person.png" width={370} height={200} alt=""></Image></div>
      </aside>
